    ...
    <form method="POST" action="{{ route('service_providers.update', $serviceProvider->id) }}" autocomplete="off">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="name" value="{{ $serviceProvider->name }}" id="name">
                @error('name')
        ...
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <input type="phone" class="form-control" id="phone_number" value="{{ $serviceProvider->phone_number }}"
                    name="phone_number">
                @error('phone_number')
                    <p class="text-danger">{{ $message }}</p>
                @enderror
